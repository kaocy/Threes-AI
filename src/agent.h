...
public:
	...
	virtual action take_action(const board& b, action prev) { return action(); }
...
public:
	...
	virtual action take_action(const board& after, action prev) {
...
public:
	...
	virtual action take_action(const board& before, action prev) {
